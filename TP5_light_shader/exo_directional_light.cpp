...
int main(int argc, char **argv)
{
    ...
    while (!done)
    {
        ...
        // glm::mat4 rot = glm::rotate(glm::mat4(1.f), windowManager.getTime(), glm::vec3(1, 1, 1));
        glm::vec3 lightDir_vs = glm::vec3(MatView * MatModele * glm::vec4(uLightDir_vs, 0));
        ...
        // glUniform1f(moonProgram.uKd,uKd*glm::linearRand(0.1f,1.f));
        // glUniform1f(moonProgram.uKs,uKs*glm::linearRand(0.1f,1.f));
        ...
        for (glm::vec3 pos : lunePosition)
        {
            ...
            lightDir_vs = glm::vec3(MatView * MatModele * glm::vec4(uLightDir_vs, 0));
