...
public:
	...
	glm::mat4 getViewMatrix() const{		
		...
		MatriceFinal = glm::rotate(MVMatrix, windowManager.getTime(), glm::vec3(0, glm::radians(m_fAngleX), 0)); // Translation * Rotation
		MatriceFinal = glm::rotate(MVMatrix, windowManager.getTime(), glm::vec3(0, glm::radians(m_fAngleY), 0)); // Translation * Rotation * Rotation
		return MatriceFinal;
	}
